...
curl -O https://download.clojure.org/install/clojure-tools-1.9.0.309.tar.gz
tar xzf clojure-tools-1.9.0.309.tar.gz
...
cp -f clojure-tools/clojure-tools-1.9.0.309.jar /usr/local/lib/clojure/libexec
...
rm -rf clojure-tools
rm -rf clojure-tools-1.9.0.309.tar.gz
